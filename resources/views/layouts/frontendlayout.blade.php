...
<head>
    ...
    <link href="{{ asset('lib\tempusdominus\js\tempusdominus-bootstrap-4.min.js') }}" rel="stylesheet" />
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <!-- Footer Start -->
        <div class="container-fluid bg-dark text-light footer wow fadeIn mt-3" data-wow-delay="0.1s">
    ...
    <script src="{{ asset('lib\tempusdominus\js\moment.min.js') }}"></script>
    <script src="{{ asset('lib\tempusdominus\js\moment-timezone.min.js') }}"></script>
    <script src="{{ asset('lib\tempusdominus\js\tempusdominus-bootstrap-4.js') }}"></script>
