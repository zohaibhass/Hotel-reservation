                    ...
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <form>
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date3" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" id="checkin"
                                            name="check_in" placeholder="Check In" data-target="#date3"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date4" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" id="checkout"
                                            name="check_out" placeholder="Check Out" data-target="#date4"
                                            data-toggle="datetimepicker" />
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <select class="form-select" name="rooms" id="select3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Special Request" id="message" names="description" tyle="height: 100px"></textarea>
